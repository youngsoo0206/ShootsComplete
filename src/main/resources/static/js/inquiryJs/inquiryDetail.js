$(function() { //ready 함수
    ...
    $(".ic-delete").click(function(){ //댓글 삭제 버튼 누르면 해당 i_commoent_id 값에 해당하는 문의댓글 삭제
		...
		location.href= `${contextPath}/iqcomments/delete?i_comment_id=${deletenum}&inquiry_idx=${inquiry_idx}`;
	}) //문의댓글 삭제 click() 끝
		...
		$(".ic-modifyComplete").click(function() {  //수정완료 버튼을 누를시 실행하는 ajax.
		    ...
		    $.ajax({
		        ...
		        success: function(response) {
		            ...
		            location.href = `${contextPath}/inquiry/detail?inquiry_idx=${inquiry_idx}`;
		        },
